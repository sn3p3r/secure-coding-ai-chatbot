...
def level(number, title, **fields):
    ...
    data = {
        ...
        "music": None,           # key into curriculum.MUSIC; None = courses/soundtrack.py decides
        "boss_music": None,      # track that takes over when the level's boss appears (default: Cretaceous Dawn)
