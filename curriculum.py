...
SFX = {
    ...
    "win": {
        "file": "audio/sfx/win.wav",
        "title": "8-bit mini win sound effect",
        "artist": "EVRetro (freesound.org)",
        "license": "Creative Commons 0 (public domain dedication)",
        "license_url": "https://creativecommons.org/publicdomain/zero/1.0/",
        "source_url": "https://freesound.org/people/evretro/sounds/535840/",
        "changes": "Downmixed to 22 kHz for size. Plays when a level (other than an obelisk) is completed and when a quiz is passed.",
    },
    "crunch": {
        "file": "audio/sfx/crunch.wav",
        "title": "crunch 7",
        "artist": "theplax (freesound.org)",
        "license": "Creative Commons: By Attribution 4.0 License",
        "license_url": "http://creativecommons.org/licenses/by/4.0/",
        "source_url": "https://freesound.org/people/theplax/sounds/608641/",
        "changes": "Downmixed to mono 22 kHz for size. Plays every time candy is eaten to heal.",
    },
}
